...
@Composable
private fun TableCell(value: String, width: androidx.compose.ui.unit.Dp, isHeader: Boolean = false) {
    Text(
        value,
        modifier = Modifier
            .width(width)
...
private fun com.buywise.android.data.VisionResult.displayVisionSummary(query: String?): String {
