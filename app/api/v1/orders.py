...
def user_ref_from_request(request: Request) -> str:
...
def create_order(
    ...
    return service.create_order(payload, user_ref_from_request(request))
...
def list_orders(
    ...
    return OrderListResponse(items=service.list_orders(user_ref_from_request(request)))
...
def get_order(
    ...
    return service.get_order(order_id, user_ref_from_request(request))
...
def advance_order(
    ...
    return service.update_order_progress(order_id, user_ref_from_request(request))
